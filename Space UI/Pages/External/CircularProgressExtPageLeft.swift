...
//  Space UI
//
//  Created by Jayden Irwin on 2022-10-28.
            ...
            HStack {
                CircularProgressView(did: 1, value: .constant(1)) {
                    CircularProgressView(did: 1, value: $progressPublisher1.value) {
                        TextPair(did: 1, label: Lorem.word(vid: vid + 1), value: Lorem.word(vid: vid + 2))
                            .padding(20)
                    }
                    .padding(20)
                }
...
struct CircularProgressExtPageLeft_Previews: PreviewProvider {
